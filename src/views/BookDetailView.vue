      ...
      <div class="row mb-4">
        ...
        <div class="col-lg-6 details-wrapper">
          <p class="lead description">
            ...
            facilis quisquam. Dolore possimus iusto quia impedit natus,
            voluptates nemo nisi! Lorem ipsum dolor sit, amet consectetur
            adipisicing elit. Amet, facilis quisquam. Dolore possimus iusto quia
            impedit natus, voluptates nemo nisi! Lorem ipsum dolor sit, amet
            consectetur adipisicing elit. Amet, facilis quisquam. Dolore
            possimus iusto quia impedit natus, voluptates nemo nisi!
          </p>
          <div class="mb-4">
